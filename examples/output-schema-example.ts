#!/usr/bin/env bun
import { ArgParser, OutputSchemaConfig, OutputSchemaPatterns, createOutputSchema } from "../src/index";
import { z } from "zod";
...
async function demonstrateOutputSchemas() {
  ...
  console.log("   ✨ LEGACY: setDefaultOutputSchema() and enableAutoOutputSchema() (still supported)");
