...
import { z } from "zod";
import { ArgParser, type IFlag } from "../../core/src/index.js";
import { generateMcpToolsFromArgParser } from "../src/index.js";
...
describe("MCP Integration", () => {
  describe("generateMcpToolsFromArgParser", () => {
    ...
    test("should handle different flag types correctly", () => {
      ...
      const tools = generateMcpToolsFromArgParser(parser);
      const schema = tools[0].inputSchema as z.ZodObject<any>;
