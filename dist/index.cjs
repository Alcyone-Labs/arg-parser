...
const zodFlagSchema = zod.z.object({
  ...
  allowLigature: zod.z.boolean().default(true).describe(
  ...
  type: zod.z.union([
    zod.z.any().refine((val) => val === String, { message: "Must be String constructor" }),
    zod.z.any().refine((val) => val === Number, { message: "Must be Number constructor" }),
    zod.z.any().refine((val) => val === Boolean, { message: "Must be Boolean constructor" }),
    zod.z.any().refine((val) => val === Array, { message: "Must be Array constructor" }),
    zod.z.any().refine((val) => val === Object, { message: "Must be Object constructor" }),
  ...
  mandatory: zod.z.union([zod.z.boolean(), zod.z.function().args(zod.z.any()).returns(zod.z.boolean())]).optional().describe("Makes the flag mandatory, can be a boolean or a function conditional on other args."),
  ...
  validate: zod.z.function().args(zod.z.any().optional(), zod.z.any().optional()).returns(zod.z.union([zod.z.boolean(), zod.z.string(), zod.z.void(), zod.z.promise(zod.z.union([zod.z.boolean(), zod.z.string(), zod.z.void()]))])).optional().describe("Custom validation function for the flag's value (receives value, parsedArgs)."),
